...
int main ()
{
    do
    {
        ...
        cout<<"9. Sisipkan Node/Data Tertentu"<<endl;
        cout<<"10. Sisipkan Setelah Node/Data Tertentu"<<endl;
        cout<<"11. Quit"<<endl;
        cout<<"Pilihan : ";
        cin>>pilihan;
        pil=atoi(pilihan);
...
void reset() {
    if(isEmpty() == 0){
        ...
        init();
        cout<<"Semua elemen pada Linked List telah dibersihkan"<<endl;
    }  else cout<<"Tidak terdapat data pada Linked List."<<endl;
}
